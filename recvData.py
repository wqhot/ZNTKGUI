        ...
        while self.isrun:
            ...
            while self.isrun:
                ...
                while curSize < length:
                    remain = 1024 if (length - curSize) > 1024 else  (length - curSize)
                    ...
                    if index != -1:
                        if index == remain - 1: #刚好结束
                            ...
                            data2 = bytearray(c_socket.recv(5 + index - remain))
                            data1.append(data2)
                            ...
                            length = int.from_bytes(bytearray(data[index + 1:index + 4]), byteorder='little')
                            curSize = 0
                            data1 = data[index + 5:]
                            allData = b''
                            allData += data1
